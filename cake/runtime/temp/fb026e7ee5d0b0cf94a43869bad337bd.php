<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\cake\public/../application/admin\view\product\add_standard.html";i:1515339252;s:59:"D:\cake\public/../application/admin\view\public\header.html";i:1515673654;s:59:"D:\cake\public/../application/admin\view\public\footer.html";i:1515674134;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_cate" id="add_cate" method="post" action="<?php echo url('add_standard'); ?>">
                        <input type="hidden" name="pid" value="<?php echo $product['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">商品名称：</label>
                            <div class="input-group col-sm-4">
                                <input  type="text" class="form-control" value="<?php echo $product['title']; ?>" disabled="disabled">
                            </div>
                        </div>
                        <div class="form-group">
